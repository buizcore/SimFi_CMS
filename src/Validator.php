...
class Validator
{
    ...
    public function addBoolean($key, $value, $notNull = false, $maxSize = null, $minSize = null)
    {
        ...
        /*
         * if( $value == '0' ) { $this->data[$key] = '-1'; } else { $this->data[$key] = $value ? '1':'0'; }
         */
    ...
    public function addDate($key, $value, $notNull = false, $maxSize = null, $minSize = null)
    {
        ...
        /*
         * if( $maxSize ) { if( strlen($value) > $maxSize ) { $this->invalid[$key] = 'max'; return 'max'; } } if( $minSize ) { if( strlen($value) < $minSize ) { $this->invalid[$key] = 'min'; return 'min'; } }
         */
    ...
    public function addLink($key, $value, $notNull = false, $maxSize = null, $minSize = null)
    {
        ...
        /*
         * if( !preg_match( self::VALIDATE_URL ,$value ) ) { $this->invalid[$key] = 'wrong'; return 'wrong'; }
         */
